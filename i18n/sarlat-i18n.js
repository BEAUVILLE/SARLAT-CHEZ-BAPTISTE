...
function makeBar(){
  ...
  var style=document.createElement('style');style.textContent='.sarlat-langs{display:flex;gap:4px;flex-wrap:wrap;justify-content:center;align-items:center}.sarlat-langs button{min-width:34px;height:32px;border:1px solid rgba(65,43,25,.22);border-radius:999px;background:#fff9;color:#25190f;font-size:10px;font-weight:1000;cursor:pointer}.sarlat-langs button.active{background:#315b43;color:#fff;border-color:#315b43}@media(max-width:600px){.sarlat-langs{width:100%;justify-content:flex-start;overflow:auto;flex-wrap:nowrap;padding-bottom:2px}}';document.head.appendChild(style);
